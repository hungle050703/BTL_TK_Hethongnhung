...
// Khai báo prototype ngoại vi để tránh lỗi implicit declaration
extern void LCD_Grid_Init(void);
...
int main(void)
{
  ...
  /* USER CODE BEGIN 1 */
  /* No display init before HAL; LCD_init is performed after SPI is ready. */
  /* USER CODE END 1 */
